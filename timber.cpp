...
int main()
{
	...
	// Some actual use log related variables
	...
	while(window.isOpen())
	{
		...
		*/
		...
		if (acceptInput)
		{
			// Handling if the right cursor is pressed
		...
		*/
		...
		if(!paused)
		{
			...
			else
			{
				...
				// Has the cloud reached the right hand end of the screen?
